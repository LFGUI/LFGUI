...
private:
    void prepare_images()
    {
        img_unchecked=image(ressource_path::get()+"gui_torus.png").scaled(height(),height()).multiplied(text_color());
        img_checked  =image(ressource_path::get()+"gui_torus_dot.png").scaled(height(),height()).multiplied(text_color());
    }
};
