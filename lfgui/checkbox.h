...
private:
    void prepare_images()
    {
        img_unchecked=image("gui_checkbox_unchecked.png").scaled(height(),height()).multiplied(text_color());
        img_checked=image("gui_checkbox_checked.png").scaled(height(),height()).multiplied(text_color());
    }
};
